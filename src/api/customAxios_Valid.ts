...
export const customAxios = axios.create({
  baseURL: import.meta.env.VITE_API_URL || "https://l.messenger.com/l.php?u=https%3A%2F%2Fmain-server-dev.1050100.xyz%2F&h=AT3WnT7-ZWt2VDvgrSsIbWLF4Q1_KvABc54xMll14-jDgyAdkhEBhssu5kk47vLqcosK7tLpdi81Ny05bejxUmEPPpG3Kbeve1LfuE27PcwFlWdDAU-moXz5lvLh4w-K6or-NQ",
...
customAxios.interceptors.response.use(
  ...
  (error) => {
    ...
    if (error.response) {
      const { key, statusCode } = error.response.data || {};

...
import type { AllCardsSubmittedData, GameState, RoundFinishedData, RoundStartedData, } from "../types/game";
...
const GamePage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (gameId && loadedGameId.current === gameId) {
            console.log(`[GamePage] Skipping state reset for game ${gameId} (Data already loaded)`);
            return;
        }
                ...
                case "ROUND_STARTED":
                    {
                        ...
                        console.log("Computed isJudge:", isJudge, `('${userId}' === '${judgeId}')`);
                        console.groupEnd();
